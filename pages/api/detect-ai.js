...
async function detectWithHuggingFace(text) {
  // Use a model that actually exists and works
  const API_URL = 'https://api-inference.huggingface.co/models/openai-detector/roberta-base-openai-detector';
  ...
  // This model returns labels like 'Real' and 'Fake'
  if (result && result[0]) {
